...
public class BotMap extends LineupMap {
    ...
    static int hitTheShipBefore = 0;  // đánh dấu xem lần trước bắn trúng hay trượt
    static int baseScore = 15; // điểm số cơ bản khi ta bắn trúng
    ...
    public boolean shoot(ActionEvent event, int i, int j) {
        ...
        if(playerShip[i][j]!=null) { // hit
            ...
            if (hitTheShipBefore == 1) {   // nếu lần trước bắn trúng
                baseScore = baseScore * 2;  // điểm cơ bản nhân đôi
                //System.out.println("Ta bắn trúng, CỘNG " + baseScore);
                ...
                //System.out.println("Ta bắn trúng, CỘNG " + baseScore);
                LineupMap.score += (baseScore);  // ko được nhân đôi điểm và cập nhật điểm hiện tại
                //System.out.println("Điểm số hiện tại: " + LineupMap.score);
                //System.out.println();
            }
            ...
            hitTheShipBefore = 0; // đánh dấu là bắn trượt
            baseScore = 15; // reset lại điểm cơ bản vì bắn trượt
            //---------------------------------------------------------
        }
